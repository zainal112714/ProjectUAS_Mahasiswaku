    ...
    <>
      <View mx={"10"} my={"auto"}>
        ...
        <Box mb={"5"}>
          ...
          <Text fontWeight={"light"} fontSize={15} mb={"1"}>Please enter your data Admin to create an account</Text>
        </Box>
        <FormControl>
          <Box mb={"5"}>
          ...
          <Box mb={"5"}>
            ...
            <Input placeholder="tulis nama kamu" borderRadius={"5"} w="100%" borderWidth={1.5} borderColor={"#9A1314"} value={email} onChangeText={(email) => setEmail(email)}/>
          </Box>
          <Box mb={"5"}>
            <Text bold={true} fontSize={18} mb={"1"}>No HP:</Text>
            <Input placeholder="tulis nama kamu" borderRadius={"5"} w="100%" borderWidth={1.5} borderColor={"#9A1314"} keyboardType="phone-pad" value={nohp} onChangeText={(nohp) => setNohp(nohp)}/>
          </Box>
          <Box mb={"5"}>
            ...
            <Input borderWidth={1.5} borderColor={"#9A1314"} w={{
              ...
              </Pressable>} placeholder="Password" secureTextEntry value={password} onChangeText={(password) => setPassword(password)} />
          </Box>
        </FormControl>
        <Center>
          <Button
            onPress={() => {
              onRegister(Loginadmin);
            }}
