...
import { Heading, Image, Text, FlatList, Form, Item, Input, Stack, Button, HStack, View, VStack, Center, Box, ScrollView,Pressable } from "native-base";
      ...
      <ScrollView>
        <View p={"5"} mb={"70"}>
          ...
          {companyList.map((item, index) => (
            <TouchableOpacity
              key={index}
             // Assuming your company object has an 'id' property
            >
              <View mb={"5"}>
